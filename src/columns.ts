/**
 * Column headings (line 2) of the two DATEV formats the validator checks
 * row by row, copied verbatim from line 2 of DATEV's own sample files
 * (Musterdaten DATEV-Format, linked from developer.datev.de, as of 2024):
 * - Buchungsstapel, Formatversion 13: 125 columns
 * - Debitoren/Kreditoren, Formatversion 5: 254 columns
 *
 * DATEV's importer reads columns by position, and DATEV's own documents spell
 * some headings differently (the portal writes "Adressatentyp", the samples
 * "Adressattyp"). A differing heading is therefore only ever a warning.
 */

/** When the rules and headings were last checked against DATEV's documents. */
export const EXTF_AS_OF = "2026-09-25";
...
/** Column count per Buchungsstapel Formatversion, from DATEV's changelog. */
export const BUCHUNGSSTAPEL_COLUMN_COUNT: Record<number, number> = { 10: 120, 11: 122, 12: 124, 13: 125 };

export const DEBKRED_COLUMNS = [
  "Konto",
